all:
	pandoc System-Reference-Manual.md metadata.yaml -f markdown -o images/BeagleBone-AI_SRM.pdf --latex-engine=xelatex --metadata link-citations --template=template.latex
